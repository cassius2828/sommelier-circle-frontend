...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-black text-gray-300 py-y px-2">
      ...
      <div className="flex md:flex-col max-w-[1240px] px-2 py-4 mx-auto items-center gap-8 justify-center md:justify-start sm:flex-row text-center text-gray-500">
