...
<main className="bg-theme-dn min-h-screen flex flex-col items-center justify-center">
  <div className="bg-theme-darkest border-gray-400 border-2 p-8 rounded-lg shadow-md w-full max-w-md">
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <label htmlFor="confirm" className="block text-gray-100 mb-2">Confirm Password:</label>
        <input
          type="password"
          id="confirm"
          value={passwordConf}
      ...
      <div>
        <label htmlFor="profile-pic" className="block text-gray-100 mb-2">Profile Picture:</label>
        <input
          type="file"
          id="profile-pic"
