...
export const NavListItem = ({ dropDownItems, listItemText }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        {listItemText}
        <ul className={`flex-col items-center justify-start bg-neutral-800 absolute -z-10  p-0 m-0  rounded-sm ${isHovered ? 'h-auto flex':'h-0 hidden'}  top-[99%] left-1/2 -translate-x-1/2`}>
